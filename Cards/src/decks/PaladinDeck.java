...
public class PaladinDeck {
	...
	public PaladinDeck(Hero hero) {
		...
		deck[22]=new Deathwing(hero);
		deck[23]=new FirePotion(hero);
		deck[24]=new PotOfGreed(hero);
		deck[25]=new PotOfGreed(hero);
		deck[26]=new Fireball(hero);
		deck[27]=new Assassinate(hero);
		deck[28]=new Brawl(hero);
